...
export function NumericStepper({
  ...
  return (
    <div
      className={cn(
        "grid gap-3 rounded-[16px] border bg-background/70 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]",
    ...
    >
      ...
      <div
        className="grid gap-3 rounded-[16px] border border-border/70 bg-background/80 p-3 sm:grid-cols-[auto_minmax(0,1fr)_auto] sm:items-center"
        aria-label={label}
      ...
      >
        <button
          ...
          className="flex h-12 w-full items-center justify-center rounded-[16px] border border-border/70 bg-card/85 text-foreground transition-all duration-300 hover:-translate-y-0.5 hover:border-navy-300/55 hover:shadow-card-hover disabled:cursor-not-allowed disabled:opacity-35 disabled:hover:translate-y-0 sm:w-12"
        >
          <Minus className="size-4" />
        </button>

        <div className="rounded-[16px] border border-border/60 bg-card/95 px-4 py-3 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
