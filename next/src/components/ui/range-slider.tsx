...
export function RangeSlider({
  ...
  return (
    <div className="space-y-3 rounded-2xl border border-border/60 bg-background/60 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="min-w-[74px] rounded-2xl border border-border/60 bg-card/90 px-3 py-2 text-right shadow-sm">
          ...
          {quickChoices.map((choice) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "min-h-11 rounded-2xl border px-3 py-2 text-sm font-semibold transition-all duration-300",
                  active
