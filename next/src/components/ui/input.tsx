        ...
        <div className="relative flex flex-col gap-1.5">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className={cn(
                "peer flex h-14 w-full rounded-2xl border border-white/20 dark:border-white/10 bg-white/50 dark:bg-navy-950/40 px-4 pt-5 pb-2 text-sm text-navy-950 dark:text-white shadow-inner backdrop-blur-md",
