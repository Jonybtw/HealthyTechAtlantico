    ...
    <div className="relative overflow-hidden rounded-xl border border-navy-700/15 bg-gradient-to-br from-navy-800 via-navy-700 to-navy-600 px-6 py-6 text-white shadow-[0_28px_80px_-36px_rgba(9,21,35,0.72)] sm:px-8 sm:py-8">
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-4xl space-y-4">
          {eyebrow || meta ? (
            <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-gold-200">
              {eyebrow ? (
          ...
          <div className="flex flex-wrap items-center gap-3">
            <h1 className="font-display text-3xl font-extrabold tracking-[-0.05em] text-white sm:text-[2.75rem]">
              {title}
            </h1>
