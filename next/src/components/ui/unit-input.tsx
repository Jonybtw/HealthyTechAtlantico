  ...
  return (
    <label className="flex flex-col gap-1.5">
      ...
      <div className="group relative">
        ...
        />
        <span className="pointer-events-none absolute right-2 top-1/2 z-10 -translate-y-1/2 rounded-lg border border-border/70 bg-background/90 px-2 py-0.5 text-micro font-semibold uppercase tracking-[0.18em] text-muted-foreground shadow-sm transition-colors duration-300 group-focus-within:border-gold-400/40 group-focus-within:text-foreground">
          {unit}
        </span>
      </div>
    </label>
