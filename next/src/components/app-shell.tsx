...
import {
  ...
  SECTION_LABEL_KEYS,
  SECTION_ORDER,
} from "@/components/chrome/nav-helpers";
import {
  AccountMenuIcon,
  AccountMenuRow,
  AccountMenuSectionLabel,
} from "@/components/chrome";
import { SyncStatusBadge } from "@/components/chrome/SyncStatusBadge";
import { BrandHeader, BRAND_NAME } from "@/components/chrome/BrandHeader";
...
export function AppShell({ user, children }: AppShellProps) {
  ...
  useDocumentTitle({ idle: BRAND_NAME, unread: "Volta ao " + BRAND_NAME });
  ...
  const groupedItems = getGroupedItems(visibleItems);
