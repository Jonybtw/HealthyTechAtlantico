      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-5 pb-28">
        <PageSection tone="primary" layout="form" className="overflow-hidden">
          <div className="grid gap-6">
            <div className="rounded-[12px] border border-border bg-surface-secondary p-5 sm:p-6">
        ...
        {currentStep === "choose" ? (
          ...
          >
            <div className="grid gap-4">
              ...
              />
              <div className="rounded-[12px] border border-dashed border-border bg-surface-secondary p-4 sm:p-5">
        ...
        {currentStep === "review" ? (
          <>
            ...
            <div className="sticky bottom-4 z-10">
              <div className="overflow-hidden rounded-[12px] border border-border bg-surface-secondary shadow-[0_4px_12px_rgba(9,21,35,0.08)] backdrop-blur">
      ...
      {steps.map((step) => {
        ...
        return (
          <button
            ...
            onClick={step.action}
            className={cn(
              "rounded-[12px] border px-4 py-4 text-left transition-all duration-300",
              active
...
function MetaChip({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-[12px] border border-border bg-surface-secondary px-3.5 py-3">
...
function BinaryRow({
  ...
  const options = [
    {
      ...
      activeClass: cn(
        interactiveControlClasses.choiceActive,
        "shadow-[0_4px_12px_rgba(9,21,35,0.08)] before:absolute before:inset-x-5 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-emerald-300/70 before:to-transparent before:content-['']",
      ),
      inactiveClass: cn(
        interactiveControlClasses.choiceInactive,
    ...
    },
    {
      ...
      activeClass: cn(
        interactiveControlClasses.choiceActive,
        "shadow-[0_4px_12px_rgba(9,21,35,0.08)] before:absolute before:inset-x-5 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-slate-200/65 before:to-transparent before:content-['']",
      ),
      inactiveClass: cn(
        interactiveControlClasses.choiceInactive,
  ...
  return (
    <fieldset className="rounded-[12px] border border-border bg-surface-secondary p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]">
      ...
      >
        {options.map((option) => (
          <button
            ...
            className={cn(
              interactiveControlClasses.choiceBase,
              "relative min-h-[92px] rounded-[12px] p-4",
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <span
                className={cn(
                  "flex size-11 items-center justify-center rounded-[12px] border transition-all duration-300",
                  option.iconClass,
                )}
              >
                {option.icon}
...
function StatusPanel({
  ...
  return (
    <div className="rounded-[12px] border border-border bg-surface-secondary p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] sm:p-5">
      <div className="flex items-start gap-3">
...
function QuestionBlock({
  ...
  return (
    <div className="rounded-[12px] border border-border bg-surface-secondary p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] sm:p-5">
      <div className="mb-4">
...
function KidmedResultSummary({
  ...
  return (
    <div className="rounded-[12px] border border-success-300/50 bg-success-50/60 p-4 dark:border-success-900/30 dark:bg-success-950/20">
